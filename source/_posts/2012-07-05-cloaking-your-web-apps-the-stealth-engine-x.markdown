...
Following on from [The Hooded Apache](http://saiweb.co.uk/hacking/linux/security/cloaking-your-webapps-the-hooded-apache/), I thought it was about time to cover Nginx configuration.
